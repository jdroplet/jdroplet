...
function checkCsnForm(form){
  form.find('input[name="user_name"]').vdsFieldChecker({rules:{required:[true, '收件人不能为空'], maxlen:[20, '收件人不能超过20个字符']}});
  form.find('select[name="name"]').vdsFieldChecker({rules:{required:[true, '请选择省份']}});
